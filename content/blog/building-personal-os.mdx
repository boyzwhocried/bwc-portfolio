...
the vault itself stays private (it's my actual life data), but the same instincts show up in public work: [Strata](https://github.com/boyzwhocried/strata), a synthetic-data pipeline built the same way, and [projects](https://boyzwhocried.xyz/projects) built alongside it.
