...
summary: "nine months into building a medallion architecture DWH at BRILife. here's what actually mattered."
published: true
---

i've been building a data warehouse at BRILife for about nine months now. bronze, silver, gold — the full medallion setup across five microinsurance products. here's what i actually learned, past the architecture diagrams.
...
still three products to go (AMKKM, AcciCare pending). will probably write a follow-up when those are done.
